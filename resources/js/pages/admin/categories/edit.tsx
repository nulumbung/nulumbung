...
import { edit, index } from '@/routes/management/categories';
...
export default function CategoriesEdit({ category }: { category: ManagedCategory }) {
    const form = useForm<{
        name: string;
        slug: string;
        icon: string;
    ...
    return (
        <>
            ...
            <h1 className="sr-only">Edit {category.name}</h1>
...
CategoriesEdit.layout = ({ category }: { category: ManagedCategory }) => ({
    breadcrumbs: [
        {
            title: 'Categories',
            href: index(),
