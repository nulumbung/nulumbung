 ...
 * @see app/Http/Controllers/RoleController.php:47
 ...
 * @see app/Http/Controllers/RoleController.php:86
 * @route '/management/roles/{role}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/management/roles/{role}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see app/Http/Controllers/RoleController.php:121
 * @route '/management/roles/{role}'
 */
